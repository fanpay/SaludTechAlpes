...
from saludtech.enriquecimiento.seedwork.dominio.entidades import AgregacionRaiz
...
def registrar_unidad_de_trabajo(serialized_obj):
    from saludtech.enriquecimiento.config.uow import UnidadTrabajoSQLAlchemy
    try:
        from flask import session
