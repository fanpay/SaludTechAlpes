...
from saludtech.enriquecimiento.seedwork.dominio.repositorios import Mapeador, Repositorio
from saludtech.enriquecimiento.seedwork.dominio.fabricas import Fabrica
from saludtech.enriquecimiento.seedwork.dominio.entidades import Entidad
