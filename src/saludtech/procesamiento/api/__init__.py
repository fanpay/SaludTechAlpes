...
def registrar_handlers():
    import saludtech.procesamiento.modulos.procesamiento.aplicacion

def importar_modelos_alchemy():
    import saludtech.procesamiento.modulos.procesamiento.infraestructura.dto
...
def comenzar_consumidor(app):
    ...
    import threading
    import saludtech.procesamiento.modulos.procesamiento.infraestructura.consumidores as procesamiento
...
def create_app(configuracion={}):
    ...
    # Inicializa la DB
    from saludtech.procesamiento.config.db import init_db
    init_db(app)
