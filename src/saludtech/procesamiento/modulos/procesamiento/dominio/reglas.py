...
from saludtech.procesamiento.seedwork.dominio.reglas import ReglaNegocio
...
class ImagenDebeSerProcesable(ReglaNegocio):
    ...
    def __init__(self, imagen: Imagen, mensaje="La imagen no puede procesarse en su estado actual."):
        super().__init__(mensaje)
        self.imagen = imagen
