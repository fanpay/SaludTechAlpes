...
from saludtech.procesamiento.modulos.procesamiento.dominio.objetos_valor import AlgoritmoAnonimizacion, EstadoProceso, FormatoSalida, ModalidadImagen, RegionAnatomica
from saludtech.procesamiento.seedwork.aplicacion.dto import DTO
