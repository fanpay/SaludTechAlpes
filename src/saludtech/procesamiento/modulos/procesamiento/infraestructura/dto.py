...
class ImagenDTO(db.Model):
    """Modelo de tabla para almacenar imágenes ."""
    ...
    id_solicitud = Column(String, nullable=True)
    cedula = Column(Integer, nullable=True)
    ...
    metadatos = relationship("MetadatosImagenDTO", backref="imagen_")
    configuracion = relationship("ConfiguracionAnonimizacionDTO", backref="imagen_")
